...
import com.nexmo.client.conversation.UpdateMemberRequest;
...
public class UpdateMember {
    public static void main(String[] args) throws Exception{
        ...
        final String MEMBER_ID = "MEM-0bccb43e-f7e1-4b4c-889e-f7d3776abcd";
        ...
        UpdateMemberRequest member = UpdateMemberRequest.builder().
        ...
        NexmoClient client = NexmoClient.builder().
                ...
                build();
        client.getConversationsClient().UpdateMember(member);
    }
}
